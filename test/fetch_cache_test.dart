...
main() {
  testWidgets("Fetch caching: one state for many fetch",
    ...
    var fetch = Column(
      children: [
        ...
        Fetch<Product?, ProductFetchParams>(
            providerKey: "FETCH_PRODUCT",
            onSuccess: (response, fetchState2) {
              fetchState_2 = fetchState2;
            },
            params: params,
            request: getProduct,
            builder: getProductBuidler)
  ...
  testWidgets("Fetch caching: outdated cache", (WidgetTester tester) async {
    var client = MockClient();
    setClient(client);
    ...
    Fetch.mapIsCaching["FETCH_PRODUCT"] = false;
